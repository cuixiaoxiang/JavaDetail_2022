...
import com.cyp.lambdaBase.entity.Author;
import com.cyp.lambdaBase.entity.Book;
import com.cyp.lambdaBase.entity.Product;
...
public class TestStream {
    ...
    private static void test101(List<Author> authors) {
        authors.stream()
                .filter(new Predicate<Author>() {
                    @Override
                    public boolean test(Author author) {
    ...
    private static void test102(List<Author> authors) {
